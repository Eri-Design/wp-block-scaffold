	...
	function initialize( $wp_customize ) {
		...
		$wp_customize->add_section(
			...
			array(
				...
				'description' => sprintf( __( 'Color Customization for %1$s', 'eri-scaffold-block-theme' ), $theme->name ),
				'title'       => __( 'Colors', 'eri-scaffold-block-theme' ),
			)
		);
		...
		$wp_customize->add_control(
			...
			array(
				...
				<p>' . __( 'Color customization for this theme is now available exclusively in the Full Site Editor Global Styles panel.<br><br>Featured Palettes can now be found in the Full Site Editor as Theme Variations.', 'eri-scaffold-block-theme' ) . '</p>
				</div>',
				'settings'    => array(),
