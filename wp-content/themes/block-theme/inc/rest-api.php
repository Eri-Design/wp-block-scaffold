 ...
 */
function eri_scaffold_remove_style_variations_from_child_themes( $response, $handler ) {
	...
	/*
	 * Prevents child themes from being considered child themes in the
...
add_filter( 'rest_request_before_callbacks', 'eri_scaffold_remove_style_variations_from_child_themes', 10, 2 );
